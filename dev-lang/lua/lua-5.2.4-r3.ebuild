...
# temp mirror for: https://www.lua.org/ftp/${P}.tar.gz
SRC_URI="
	https://www.tecgraf.puc-rio.br/lua/mirror/ftp/${P}.tar.gz
	test? ( https://www.tecgraf.puc-rio.br/tests/${TEST_P}.tar.gz )"
