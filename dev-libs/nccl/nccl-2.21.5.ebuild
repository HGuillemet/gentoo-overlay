...
SRC_URI="
	...
	cuda12-4? ( nccl_${PV}-1+cuda12.4_x86_64.txz )"
S="${WORKDIR}"

SLOT="0/8"
KEYWORDS="amd64 amd64-linux"
IUSE="cuda11-0 cuda12-2 +cuda12-4"
REQUIRED_USE="^^ ( cuda11-0 cuda12-2 cuda12-4 )"
RESTRICT="fetch"

RDEPEND="
	cuda11-0? ( =dev-util/nvidia-cuda-toolkit-11* )
	cuda12-2? ( =dev-util/nvidia-cuda-toolkit-12.2* )
	cuda12-4? ( =dev-util/nvidia-cuda-toolkit-12.4* )"
...
src_install() {
	...
	if use "cuda12-4"; then 
	  DIR="nccl_${PV}-1+cuda12.4_x86_64"
	fi
