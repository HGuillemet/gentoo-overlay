...
src_prepare() {
	...
	rm -rv ./plugins/intellij-rust/bin/macos || die
...
src_install() {
	...
	insinto "${dir}"
	doins -r *
	# Faire find . -file -perm 755 dans archive source pour obtenir la liste:
	...
	fperms 755 "${dir}"/plugins/javascript-base/helpers/package-version-range-matcher/node_modules/semver/bin/semver.js
